...
function getEraPlayerAttrs(pos, ovr) {
  ...
  keys.forEach(function(k) {
    var v = (tpl[k] != null ? tpl[k] : base[k]) + (ovrN - 85) * 0.65 + (Math.random() * (ovrN >= 88 ? 8 : 13) - (ovrN >= 88 ? 4 : 6.5));
...
var ERA_EXTRA_PLAYERS = {
  ...
  'Moses Malone': ['摩西-马龙', 'C', 90, { threePT: 27, MID: 62, FIN: 98, DNK: 82, HAN: 72, PAS: 52, PDEF: 81, IDEF: 97, BLK: 86, REB: 99, ATH: 80, STR: 97, CLU: 93 }],
  ...
  'Ben Wallace': ['本-华莱士', 'C', 90, { threePT: 26, MID: 32, FIN: 72, DNK: 80, HAN: 38, PAS: 38, PDEF: 99, IDEF: 99, BLK: 99, REB: 99, ATH: 88, STR: 99, CLU: 90 }],
  ...
  'Samuel Dalembert': ['萨缪尔-戴勒姆波特', 'C', 76, { threePT: 25, MID: 40, FIN: 72, DNK: 72, HAN: 42, PAS: 35, PDEF: 78, IDEF: 86, BLK: 88, REB: 86, ATH: 70, STR: 82, CLU: 62 }],
...
var ERA_ROSTERS = {
  ...
  1996: {
    ...
    DEN: ['Antonio McDyess', 'LaPhonso Ellis', 'Mark Jackson', 'Dale Ellis', 'Tom Hammonds', 'Steve Hamer', 'Ernest Johnson', 'Sarunas Marciulionis', 'Anthony Goldwire', 'Brooks Thompson'],
...
function lookupEraPlayer(en) {
  if (typeof ERA_EXTRA_PLAYERS !== 'undefined' && ERA_EXTRA_PLAYERS[en]) {
    ...
    return { src: 'extra', data: { en: en, cn: e0[0], pos: e0[1], ovr: e0[2], attrs: e0[3] } };
  }
